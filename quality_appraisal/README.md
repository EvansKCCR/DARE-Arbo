...
- `DARE_Arbo_guidelines.docx` - audited scoring codebook and operational rules.
- `Supplementary_methods.docx` - active-infection and neutralizing-antibody endpoint/tier harmonization.
